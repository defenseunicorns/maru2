	...
	testCases := []struct {
		...
		},
		{
			...
			wf: v0.Workflow{
				SchemaVersion: v0.SchemaVersion,
				Tasks: v0.TaskMap{
					"task1": v0.Task{v0.Step{
						Run: "echo first",
					}},
					"task2": v0.Task{v0.Step{
						Uses: "task1",
					}},
				},
			},
