...
While this is supported in GitLab, it is not in GitHub and consistency is better in this case. If this behavior is desired, it can always be added later in a non-breaking fashion.
